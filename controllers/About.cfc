<cfcomponent extends="Controller" output="false">
	...
	<cffunction name="edit">
		...
		<cfset data.page = model("page").findOne(where="pageName = 'About'")>
	...
	<cffunction name="index">
		...
		<cfset data.content = model("page").findOneByPageName(pageName="About", returnAs="query")>
		
		<!--- Set which page we're on for the bottom navigation --->
		<cfset data.page = 'about'>
