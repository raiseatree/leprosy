	...
	<cffunction name="add">
		...
		<cfif IsPost()>
			...
			<cfelse>
				...
				<!--- Mail Tom --->
				<cfset sendEmail(to="info@tom-bradley.com", cc="andystephenson88@gmail.com", from="hello@isleprosyeliminated.com", template="signup", name="#params.reservation.firstName# #params.reservation.surname#", email=params.reservation.email)>
