<cfoutput>
	...
	#errorMessagesFor("data.page")#
	
	<p>#textArea(objectName="data.page", property="content", label="Page Content", rows="25", prepend="<br/>")#</p>

	#hiddenField(objectName="data.page", property="id")#
